...
# in abhängigkeit vom current state!
...
def H_pulse(drive_strength, sigma, current_state, plot_prob=False, plot_blochsphere=False):
    ...
    return pulse(drive_strength=drive_strength, sigma=sigma, duration=duration, omega=omega, phase=phase, expected_state=expected_state, current_state=current_state,
