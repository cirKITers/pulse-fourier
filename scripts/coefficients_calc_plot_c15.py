...
directory_path_gate = "../results/c15_exp/gate/"
model_name_gate = "Circuit15_Random"
...
if fx_set_gate is not None:
    print("Loaded gate fx_set shape:", fx_set_gate.shape)


directory_path_pulse = "../results/c15_exp/pulse/"
model_name_pulse = "Pulse15_Random_Parallel_Joblib"
...
if fx_set_pulse is not None:
    print("Loaded pulse fx_set shape:", fx_set_pulse.shape)
...
parameter_set = combine_parameter_sets(num_samples, 2, num_qubits, len(["RY", "RY"]), seeds)
