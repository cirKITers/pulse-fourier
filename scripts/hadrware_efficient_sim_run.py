from qft_models.hardware_efficient_sim import *
...
parameter_set = random_parameter_set2(num_samples, 2, num_qubits, len(["RY", "RZ", "RY"]))

print(parameter_set)

fx_set = model.sample_fourier(x, parameter_set, num_samples)
# save_set("CircuitHE_Random", num_qubits, num_layers, num_samples, x, fx_set, "../results/fx_data.txt")
